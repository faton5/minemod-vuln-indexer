...
def write_reports(
    ...
    *,
    ...
    recent_security_fix_candidates: list[BaseModel] | None = None,
) -> None:
    ...
    if recent_security_fix_candidates is not None:
        write_json(
            output_directory / "recent_security_fix_candidates.json",
